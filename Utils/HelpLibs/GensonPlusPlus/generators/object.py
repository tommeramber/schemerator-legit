...
class Object(SchemaGenerator):
    ...
    def add_object(self, obj):
        ...
        if GlobalConfig.global_config.vars.ADD_REQUIRED_IN_JSON_SCHEMA:
    ...
    def to_schema(self):
        ...
        # todo:
        ### have problam with this because after that in node.py
        ### we check if len(generated_schema) == 1 and this is not 1 in object case.
        return schema
