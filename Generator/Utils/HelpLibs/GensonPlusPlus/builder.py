...
class SchemaBuilder(object):
    ...
    """
    DEFAULT_URI = 'Generated with Schemerator'
    NULL_URI = 'NULL'
    ...
    def add_schema(self, schema):
        ...
        if '$schema' in schema:
            # if schema_uri is None then take the $schema val from schema.
    ...
    def to_schema(self):
        ...
        # If schema is empty then add additionalProperties = false.
        # when len(schema.keys) is 1 its mean that it hold only "$schema" key.
